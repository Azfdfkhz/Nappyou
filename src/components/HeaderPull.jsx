...
export default function HeaderPull({ onOpenChange }) {
  ...
  return (
    <div className="flex flex-col items-center w-full mt-6 select-none relative">
      {/* Header atas */}
      <div className="w-[calc(100vw-60px)] max-w-[430px] rounded-t-[28px] flex justify-between items-center px-6 py-3 shadow-md border border-white/20 bg-gradient-to-r from-[#1E2F57] to-[#2E4A76]">
      ...
      <motion.div
        ...
        className="overflow-hidden w-[calc(100vw-60px)] max-w-[430px] border-x border-white/20 flex flex-col items-center relative bg-gradient-to-b from-[#4C6EA8] to-[#A8C4E8]"
      >
        {isOpen && (
          <motion.div
            initial={{ scaleY: 0.95 }}
      ...
      <motion.div
        ...
        animate={{
          scaleY: isOpen ? [1, 1.05, 1] : [1, 0.98, 1],
        }}
        transition={{ duration: 0.3, ease: "easeInOut" }}
        className="relative w-[calc(100vw-60px)] max-w-[430px] text-center text-white py-4 rounded-b-[28px] border border-white/20 shadow-inner cursor-grab active:cursor-grabbing -mt-[1px] bg-gradient-to-r from-[#1E2F57] to-[#2E4A76]"
      >
        {isOpen ? "Tutup" : "Tarik"}
